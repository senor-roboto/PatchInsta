...
def metadata(config, release):
    ...
    return {'created_at':created, 'description':'Candidate 4.1.8 : garde Fold Reels et audit Litho bornés ; 60/60 local et démarrage émulateur vérifiés, rendu visuel Fold/Réels encore non confirmé.',
