...
[**Télécharger piko-fold-reels-v4 (ZIP)**](https://github.com/senor-roboto/PatchInsta/actions/runs/34158065318/artifacts/10031713079), en étant connecté à GitHub. Extraire `piko-fold-reels-v4.mpp`, puis l’ouvrir avec Morphe. Sélectionner **la source v4 uniquement** et cocher **Adaptive Fold Reels (experimental)**. Repartir de l’APKM original 439.0.0.37.89 / arm64. Garder le même package Clone et la même clé de signature pour mettre à jour l’installation existante.

Bundle compilé le **7 septembre 2026**, depuis le commit `fc04babe64b2fcb4a6feca5c5bc3ffef355ba2da`. Le ZIP contient le `.mpp`, sa somme SHA-256, le guide et les licences. Cet artefact expire le **21 septembre 2026** ; utiliser **Run workflow** dans [Actions](https://github.com/senor-roboto/PatchInsta/actions/workflows/build-fold-reels.yml) pour le reconstruire ensuite.
...
La [compilation de cette révision](https://github.com/senor-roboto/PatchInsta/actions/runs/34158065318) a réussi : **253 assertions JVM**, **13 clés natives et ressources FR/EN**, **14 scénarios de vues Android, aucun échec ni scénario ignoré**. Ces tests ne remplacent ni le patching de l’APKM ni le rendu sur le Fold ; le menu fournit un diagnostic structurel copiable.
